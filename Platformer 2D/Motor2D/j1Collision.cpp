...
j1Collision::j1Collision()
{
	...
	matrix[COLLIDER_DEATH][COLLIDER_PLAYERFUTURE] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_LEVELEND] = true;
	...
	matrix[COLLIDER_PLAYERFUTURE][COLLIDER_LEVELEND] = false;
	matrix[COLLIDER_PLAYERFUTURE][COLLIDER_DEATH] = false;
